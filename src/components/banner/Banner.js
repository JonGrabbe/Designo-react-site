...
export default function Banner(props) {
    let smallCirclePath = '../../assets/shared/desktop/bg-pattern-small-circle.png';
    let circleWidth = 292;
    let imgUrl = `url(${process.env.PUBLIC_URL}/assets/shared/desktop/bg-pattern-small-circle.png)`;
    ...
    let styles = {
        ...
        backgroundPosition: `100px -80px, 100px 208px, -100% 208px`,
